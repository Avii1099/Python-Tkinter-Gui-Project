...
class App(tk.Tk):
    ...
    def create_header_frame(self):
        ...
        # save button
        self.save_button = ttk.Button(self.header, text="Save")
        self.save_button["command"] = self.save_as
        self.save_button.grid(column=3, row=0, sticky=tk.E)
